	...
	for line in samples:
		...
		with open(withlengths) as lengths:
			...
			for line in lengths:
				...
				insertion = insInfo[0][:lengthcount] #slider1; the number after ":" should go from 1-15, the number after ":" indicates number of letters you want;
				insCount = int(insInfo[1])
